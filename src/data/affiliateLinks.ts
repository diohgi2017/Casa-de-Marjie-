...
export const OWNER_IDS = {
  amazon: "glowtrack-20",  // ← FILL THIS AFTER AMAZON APPROVAL
  ulta: "GLOWTRACK123",    // ← FILL THIS AFTER ULTA APPROVAL
};
...
export const affiliateLinks: Record<string, AffiliateLink> = {
  "cerave-foaming-facial-cleanser": {
    ...
    ulta: `https://www.ulta.com/p/cerave-foaming-facial-cleanser?utm_source=glowtrack&utm_medium=affiliate`,
  },
  "innisfree-super-volcanic-pore-clay-mask": {
    amazon: `https://www.amazon.com/dp/B00V27Y7V0?tag=${OWNER_IDS.amazon}`,
    ulta: `https://www.ulta.com/p/innisfree-super-volcanic-clay-mask?utm_source=glowtrack`,
  },
  "the-ordinary-niacinamide-10-zinc-1": {
    amazon: `https://www.amazon.com/dp/B01N0P6Z0B?tag=${OWNER_IDS.amazon}`,
    ulta: `https://www.ulta.com/p/the-ordinary-niacinamide?utm_source=glowtrack`,
  },
};
